 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://ws.accenture.com/", wsdlLocation = "http://localhost:8981/tss/CalculatorService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://ws.accenture.com/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8981/tss/CalculatorService?wsdl");
    ...
    public Calculator getCalculatorImplPort() {
        return super.getPort(new QName("http://ws.accenture.com/", "CalculatorImplPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.accenture.com/", "CalculatorImplPort"), Calculator.class, features);
    }
